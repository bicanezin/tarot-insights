...
export const tarotDeck: TarotCard[] = [
  { id: 0, name: 'The Fool', meaning_up: 'New beginnings, innocence, spontaneity', meaning_rev: 'Recklessness, being taken advantage of', desc: 'Represents a new journey.', yesNo: 'Yes', imageName: 'the fool', imageUrl: "https://cdn.pixabay.com/photo/2021/02/15/07/52/the-fool-6016940_1280.jpg" },
  { id: 1, name: 'The Magician', meaning_up: 'Willpower, desire, creation, manifestation', meaning_rev: 'Trickery, illusions, out of touch', desc: 'Tapping into your full potential.', yesNo: 'Yes', imageName: 'magician staff', imageUrl: "https://cdn.pixabay.com/photo/2021/02/15/07/52/the-fool-6016940_1280.jpg" },
  ...
  { id: 5, name: 'The Hierophant', meaning_up: 'Tradition, conformity, morality', meaning_rev: 'Rebellion, subversiveness, new approaches', desc: 'Following established conventions.', yesNo: 'Maybe', imageName: 'hierophant keys', imageUrl: "https://cdn.pixabay.com/photo/2021/02/15/07/52/the-fool-6016940_1280.jpg" },
  { id: 6, name: 'The Lovers', meaning_up: 'Partnerships, duality, union', meaning_rev: 'Disalignment, one-sidedness', desc: 'Represents a significant choice or relationship.', yesNo: 'Yes', imageName: 'lovers couple', imageUrl: "https://cdn.pixabay.com/photo/2021/02/15/07/52/the-fool-6016940_1280.jpg" },
  { id: 7, name: 'The Chariot', meaning_up: 'Direction, control, willpower', meaning_rev: 'Lack of control, aggression', desc: 'Moving forward with determination.', yesNo: 'Yes', imageName: 'chariot horses', imageUrl: "https://cdn.pixabay.com/photo/2021/02/15/07/52/the-fool-6016940_1280.jpg" },
